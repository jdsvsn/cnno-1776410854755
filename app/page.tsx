...
const basePath = '/cnno-1776410854755';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft and deliver exceptional artisanal cinnamon rolls that exceed customer expectations, fostering a warm and inviting experience for the community.</p>
                </div>
                <div className="space-y-2">
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-center gap-6">
            ...
            <a href={`https://wa.me/601117957335`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
